...
export function seedPaymentTransactions(count: number = 1000): PaymentTransaction[] {
  ...
  for (let i = 0; i < count; i++) {
    ...
    transactions.push({
      ...
      email: faker.helpers.maybe(() => faker.internet.email(), { probability: 0.3 }) || null,
      ...
      sourceBankCode: null,
      customerAccountNumber: faker.helpers.maybe(() => faker.finance.accountNumber(), { probability: 0.2 }) || null,
