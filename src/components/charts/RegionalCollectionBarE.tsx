...
import type { RegionalCollection } from "@/domain/payments";

export default function RegionalCollectionBarE({
  data
}: {
  data: RegionalCollection[];
}) {
  // Debug: Log data to console
  console.log("RegionalCollectionBarE data:", data);
    ...
    series: [
      {
        ...
        itemStyle: {
          color: {
            ...
            colorStops: [
              ...
              {
                offset: 1,
                color: cssVar("--primary", "#3b82f6") + "B3"
              }
            ]
          }
        },
        emphasis: {
          itemStyle: {
            color: cssVar("--primary", "#3b82f6"),
            shadowBlur: 10,
            shadowColor: cssVar("--primary", "#3b82f6") + "80"
          }
        }
      }
    ]
